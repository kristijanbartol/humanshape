...
%% register human scan
%scanName = 'scan';
scan = dir('./obj/SPRING0001.obj');
scanFolder = scan(1).folder;
scanName = scan(1).name;
%fprintf(scanFolder);
%fprintf(scanName);
%scanFilenames = {[scanFolder '/' scanName]};
scanFilename = {fullfile(scanFolder, scanName)};
%landmarkFilenames = {[scanName '.lnd']};
landmarkFilenames = {};
fprintf('register human scan\n');
fitMesh(scanFilename,landmarkFilenames,expidx);
